...
const d = document,
  $food = d.getElementById("foods"),
  $template = d.getElementById("food-tamplate").content,
...
Promise.all([
  ...
  .then((json) => {
    ...
    prices.forEach((el) => {
      ...
      $template.querySelector(".food").setAttribute("data-price", el.id);
