export function ContactForm() {
  ...
  $form.innerHTML = `
    <legend class="contact-form-legend">Envíanos tus comentarios</legend>
    <input type="text" name="name" placeholder="Escribe tu nombre"
      title="Nombre sólo acepta nombres y espacios en blanco" pattern="^[A-Za-zÑñÁáÉéÍíÓóÚúÜü\\s]+$" required>
    ...
    <textarea name="comments" cols="50" rows="5" placeholder="Escrube tus comentarios"
  ...
  function validationsForm() {
    ...
    d.addEventListener("keyup", (e) => {
      if (e.target.matches(".contact-form [required]")) {
        ...
        if (pattern && $input.value !== "") {
          ...
          // console.log(d.getElementById($input.name).classList);
    ...
    d.addEventListener("submit", (e) => {
      ...
      fetch("https://formsubmit.co/ajax/bryanbaez2504@gmail.com", {
        method: "POST",
