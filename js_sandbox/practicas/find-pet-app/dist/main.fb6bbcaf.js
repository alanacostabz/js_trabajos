...
function fetchAnimals(e) {
  ...
  (0, _fetchJsonp.default)("http://api.petfinder.com/pet.find?format=json&key=EgYHbeceBrApljH3MxTGZBd2GizgomOOouv6vH9K&animal=".concat(animal, "&location=").concat(zip, "&callback=callback"), {
